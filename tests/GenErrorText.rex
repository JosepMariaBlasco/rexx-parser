...
/******************************************************************************/
  ...
  -- Accept optional path to rexxmsg.xml; default: same directory
  If Arg(1, "E") Then rexxMsg = Arg(1)
                 Else rexxMsg = "rexxMsg.xml"
  ...
  Say "/* which is located in the tests directory.                                  */"
  Say "/*                                                                            */"
